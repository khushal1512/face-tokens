...
class _TokenEntry_0 {
  alignment() {
    return _descriptor_2.alignment().concat(_descriptor_6.alignment().concat(_descriptor_1.alignment().concat(_descriptor_2.alignment())));
  }
  fromValue(value_0) {
    return {
      tokenId: _descriptor_2.fromValue(value_0),
      owner: _descriptor_6.fromValue(value_0),
      faceHash: _descriptor_1.fromValue(value_0),
      livenessScore: _descriptor_2.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_2.toValue(value_0.tokenId).concat(_descriptor_6.toValue(value_0.owner).concat(_descriptor_1.toValue(value_0.faceHash).concat(_descriptor_2.toValue(value_0.livenessScore))));
  }
}

const _descriptor_7 = new _TokenEntry_0();
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.localFaceVectorHash) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named localFaceVectorHash');
    }
    if (typeof(witnesses_0.localLivenessScore) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named localLivenessScore');
    }
      ...
      mint: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('mint',
                                     ...
                                     'facetoken.compact line 19 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_6.toValue(to_0),
        ...
        const result_0 = this._mint_0(context, partialProofData, to_0);
      ...
      verifyHuman: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('verifyHuman',
                                     'argument 1 (as invoked from Typescript)',
                                     'facetoken.compact line 46 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
  ...
  _localFaceVectorHash_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.localFaceVectorHash(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('localFaceVectorHash',
                                 'return value',
                                 'facetoken.compact line 16 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
  ...
  _localLivenessScore_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.localLivenessScore(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(typeof(result_0) === 'bigint' && result_0 >= 0n && result_0 <= 18446744073709551615n)) {
      __compactRuntime.typeError('localLivenessScore',
                                 'return value',
                                 'facetoken.compact line 17 char 1',
                                 'Uint<0..18446744073709551616>',
                                 result_0)
    }
    partialProofData.privateTranscriptOutputs.push({
  ...
  _mint_0(context, partialProofData, to_0) {
    const hash_0 = this._localFaceVectorHash_0(context, partialProofData);
    const score_0 = this._localLivenessScore_0(context, partialProofData);
    let t_0;
    __compactRuntime.assert((t_0 = score_0, t_0 >= 70n),
  ...
  _verifyHuman_0(context, partialProofData, tokenId_0) {
    __compactRuntime.assert(_descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
      ...
      member(...args_0) {
        ...
        if (!(typeof(key_0) === 'bigint' && key_0 >= 0n && key_0 <= 18446744073709551615n)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'facetoken.compact line 12 char 1',
                                     'Uint<0..18446744073709551616>',
                                     key_0)
        }
        return _descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
    ...
    faceHashes: {
      ...
      member(...args_0) {
        ...
        if (!(key_0.buffer instanceof ArrayBuffer && key_0.BYTES_PER_ELEMENT === 1 && key_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'facetoken.compact line 13 char 1',
                                     'Bytes<32>',
                                     key_0)
        }
        return _descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
...
const _dummyContract = new Contract({
  localFaceVectorHash: (...args) => undefined,
  localLivenessScore: (...args) => undefined
});
